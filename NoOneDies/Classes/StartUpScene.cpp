...
bool StartUp::init()
{
    ...
    titleLabel->setPosition(visibleSize.width/2, visibleSize.height - titleLabel->getContentSize().height/2-100);
    addChild(titleLabel);
...
void StartUp::addBtns(){
    ...
    btnTwo->setString("一排跑道");
    btnTwo->setPosition(visibleSize.width/2, visibleSize.height/2+25);
    addChild(btnTwo);
    
    btnThree = Label::create();
    btnThree->setSystemFontSize(32);
    btnThree->setColor(Color3B::BLACK);
    btnThree->setString("两排跑道");
    ...
    btnFour->setString("三排跑道");
    btnFour->setPosition(visibleSize.width/2, visibleSize.height/2-75);
    addChild(btnFour);
    
    btnFive = Label::create();
    btnFive->setSystemFontSize(32);
    btnFive->setColor(Color3B::BLACK);
    btnFive->setString("四排跑道");
    btnFive->setPosition(visibleSize.width/2, visibleSize.height/2-125);
    addChild(btnFive);
}
